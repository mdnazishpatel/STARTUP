...
function Register() {
  ...
  const floatingIcons = [
    ...
    { icon: Mail, position: { x: 85, y: 15 }, delay: 1 },
    { icon: Lock, position: { x: 15, y: 70 }, delay: 2 },
  ];
      ...
      <div className="min-h-screen relative flex items-center justify-center p-6 bg-slate-950 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">Transform Your Ideas Into Reality</p>
          </div>
          <div className="glass-morphism p-10 shadow-2xl">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-2">Create Your Account</h2>
              <p className="text-gray-400 text-lg">Join thousands of entrepreneurs building the future</p>
            </div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-white/10 border ${
                      focusedField === 'name' ? 'border-purple-500 glow' : 'border-white/20'
                    ...
                    style={{ transform: focusedField === 'name' ? 'scale(1.02)' : 'scale(1)' }}
                  />
